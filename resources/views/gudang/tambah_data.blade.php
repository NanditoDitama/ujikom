                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        <i class="fa fa-search me-2"></i><b>Cari</b>
                                    </button>
                                </div>
                            </div>
                            <div class="mt-3">
                            ...
                            <div class="mt-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="qty" id="qty" placeholder="Qty Masuk" onchange="shTtl()">
                                    <span class="input-group-text">Pcs</span>
                                </div>
                            </div>
                            <div class="mt-3">
                                <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-save me-2"></i>Simpan</button>
                                <a href="/previous-page" class="btn btn-danger btn-sm"><i class="fa fa-undo me-2"></i>Kembali</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mt-3">
                                <label for="no_transaksi" class="form-label">No Transaksi</label>
                                <input type="text" name="no_transaksi" id="no_transaksi" class="form-control" disabled placeholder="Terisi Otomatis">
                            </div>
                            <div class="mt-3">
                                <label for="tgl" class="form-label">Tgl Masuk</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal"><i class="fa fa-undo me-2"></i>Close</button>
                </div>
            </div>
        </div>
    </div>
